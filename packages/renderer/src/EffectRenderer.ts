...
export class FadeRenderer extends EffectRenderer<FadeEffect, FadeState> {
	initState() {
...
export class TranslateRenderer extends EffectRenderer<TranslateEffect, TranslateState> {
	initState() {
		this.state = {
			initPosition: {
...
export class RotateRenderer extends EffectRenderer<RotateEffect, RotateState> {
	initState() {
		this.state = {
...
export class ScaleRenderer extends EffectRenderer<ScaleEffect, ScaleState> {
	initState() {
		this.state = {
			initScale: {
